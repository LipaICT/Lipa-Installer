...
function Show-Menu {
    ...
    Write-Host "1. Add device to AD domain"
    Write-Host "2. Package Installation Script HP"
    Write-Host "3. Package Installation Script Lenovo"
    Write-Host "4. Endpoint Configuration Script"
    Write-Host "5. Move and rename splashtop"
    Write-Host "6. Generate Spec Sheet"
    Write-Host "7. Autotask Ticket Entry Generation Script"
...
while ($true) {
    ...
    switch ($choice) {
        ...
        "2" {
            Write-Host "Running HP Package Installation Script..." -ForegroundColor Cyan
        ...
        "3" {
            Write-Host "Running Lenovo Package Installation Script..." -ForegroundColor Cyan
            Invoke-Restmethod "https://raw.githubusercontent.com/LipaICT/Lipa-Installer/refs/heads/main/scripts/Install-Packages-Lenovo.ps1" | Invoke-Expression
            Read-Host "Press Enter to continue..."
        }
        "4" {
